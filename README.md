...
- [Routing](./routing/) - Routes each request to the smallest sufficient Claude model (Haiku → Sonnet → Opus) to minimise token costs, escalating only when lighter models cannot meet quality requirements.
